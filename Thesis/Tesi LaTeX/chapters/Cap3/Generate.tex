...
\begin{enumerate}
    \item \label{en:gghpriv1} Generare una base $\mathbf{R}$ casuale: ogni elemento viene scelto in maniera casuale
    ...
    di calcolo.
    \item \label{en:gghpriv2} Generare una base $\mathbf{R}$ rettangolare: si inizia con il moltiplicare la matrice identità
