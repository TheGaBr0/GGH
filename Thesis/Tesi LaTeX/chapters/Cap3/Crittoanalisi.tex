...
due soluzioni:
\begin{enumerate}
    \item  \label{en:nguyen1} Moltiplicare per 2 l'equazione \ref{eq:Nguyen2} ottenendo così $\mathbf{e} \in \{\pm 1\}^n$.
    ...
    \item \label{en:nguyen2} Aggiungere un vettore costante  $\mathbf{s} = (\sigma,\dots,\sigma)$ e 
