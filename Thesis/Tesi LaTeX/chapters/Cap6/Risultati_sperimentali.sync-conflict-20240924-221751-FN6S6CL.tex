...
\begin{table}[H]
    ...
    \end{tabular}
    \caption[GGH-HNF in \cite{HNF04} vs implementazione proposta: tempi d'esecuzione]
...
In merito a GGH-HNF, le informazioni provengono da due fonti principali: 
la pubblicazione originale \cite{HNF01}, che illustra le dimensioni dei testi cifrati, 
e il report tecnico di Ludwig Christoph \cite{HNF04}, che approfondisce i tempi di 
esecuzione e gli aspetti relativi alla sicurezza. Un breve riassunto delle differenze tra 
...
la generazione della chiave pubblica si riduce da 46 ore a 22.277 secondi. 
Questi progressi si traducono in un'accelerazione di oltre 2700 volte per la chiave privata e 
circa 7400 volte per la chiave pubblica.
